    ...
    <div id="ina__dp_logout_message_box" class="ina-dp-noflict-modal">
        <div class="ina-dp-noflict-modal-content">
            <div class="ina-dp-noflict-modal-body ina-dp-noflict-wakeup">
				...
				?>
                <p class="ina-dp-noflict-btn-container"><a class="button button-primary ina_stay_logged_in" href="javascript:void(0);"><?php esc_html_e( 'Continuar', 'inactive-logout' ); ?></a></p>
            </div>
        </div>
    </div>
<?php } else { ?>
    <div id="ina__dp_logout_message_box" class="ina-dp-noflict-modal">
        <div class="ina-dp-noflict-modal-content">
            <div class="ina-modal-header">
                <h3><?php esc_html_e( 'Inactividad', 'inactive-logout' ); ?></h3>
            </div>
            <div class="ina-dp-noflict-modal-body">
				...
				?>
                <p class="ina-dp-noflict-btn-container"><a class="button button-primary ina_stay_logged_in" href="javascript:void(0);"><?php esc_html_e( 'Continuar', 'inactive-logout' ); ?> <span class="ina_countdown"></span></a></p>
            </div>
        </div>
    </div>
<?php } ?>

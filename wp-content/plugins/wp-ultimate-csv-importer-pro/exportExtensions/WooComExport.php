...
class WooCommerceExport {
	...
	public function getProductData($id, $type, $optionalType)
	{
		...
		if($tax_class == ''){
			WooCommerceExport::$export_instance->data[$id]['tax_class'] = '1';
		}elseif($tax_class == 'reduced-rate'){
			WooCommerceExport::$export_instance->data[$id]['tax_class'] = '2';
		}elseif($tax_class == 'zero-rate'){
			WooCommerceExport::$export_instance->data[$id]['tax_class'] = '3';
		}elseif($tax_class == 'parent'){
			WooCommerceExport::$export_instance->data[$id]['tax_class'] = '4';
		}

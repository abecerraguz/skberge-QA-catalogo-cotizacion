...
function dl_enqueue_scripts() {
	...
	wp_register_script( 'select', get_theme_file_uri('/assets/js/lib/bootstrap-select.js'), array('jquery-migrate'), null, true );
	wp_register_script( 'zoomjs', get_theme_file_uri('/assets/js/lib/xzoom.min.js'), array('jquery-migrate'), null, true );
	wp_register_script( 'zoomjs-scripts', get_theme_file_uri('/assets/js/script-zoom.js'), array('jquery-migrate'), null, true );
	...
	wp_enqueue_script( 'zoomjs' );
	wp_enqueue_script( 'zoomjs-scripts' );

...
function dl_custom_search_form_bootstrap_4() {
	...
	$form .= 	'<input type="search" class="form-control mr-2 w-100" placeholder="Buscar lugar" name="s" value="" aria-label="Search">';
	$form .= 	'<button type="submit" class="btn btn-outline-green my-2 my-sm-0" aria-label="Buscar"><i class="fas fa-search"></i></button>';
	$form .= '</form>';

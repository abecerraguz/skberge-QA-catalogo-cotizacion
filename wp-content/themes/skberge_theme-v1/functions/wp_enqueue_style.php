...
function dl_enqueue_style() {
	...
	wp_register_style( 'google_font', 'https://fonts.googleapis.com/css?family=Lato:400,700&display=swap');
	wp_register_style( 'select', get_theme_file_uri( '/assets/css/bootstrap-select.css'), 'main_style', $theme_data->get( 'Version' ), 'screen' );
	wp_register_style( 'zoom', get_theme_file_uri( '/assets/css/xzoom.css'), 'main_style', $theme_data->get( 'Version' ), 'screen' );
